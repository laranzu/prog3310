...
\begin{IMPORTANT}
Don't think about the name of the program or the command line argument. This is an
...
The second program is similar, in that it reads input and writes output, but is
not identical. Open the source code in your editor / IDE and run the program.
...
are, and try both values. (If you don't already know, you can stop a runaway program
with \NAME{Control-C}.)
