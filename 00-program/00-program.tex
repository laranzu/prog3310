...
you typing \NAME{Control-D}, or \NAME{Control-Z} then \NAME{Enter}, depending on your system.
...
you can usually stop a runaway program with \NAME{Control-C}. (On MS Windows, first
try \NAME{Control-C} and if that doesn't work, \NAME{Control-Pause/Break}).
