...
available on your computer. Try this.

Run the program on the source code again, but this time with a second command
line argument \texttt{SHA1}. How many bits are there in this signature?
...
was not written by a security expert so is not efficient or guaranteed
to work properly.
